...
Alunos marcados manualmente pelo chefe como PCD/ND atingem a pontuação máxima realizando 75% da
...
3. Para aluno PCD/ND, o equivalente enviado é `min(total da lista, acertos / 0,75)`, arredondado
   para duas casas decimais.
4. Acertos acima de 75% não geram valor acima do total da lista.
